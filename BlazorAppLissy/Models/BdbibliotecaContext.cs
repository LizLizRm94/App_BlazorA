...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=b403-08\\SQLEXPRESS;DataBase=BDBIBLIOTECA;Integrated Security=True;Encrypt=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Autor>(entity =>
        {
            ...
            entity.HasOne(d => d.IidpaisNavigation).WithMany(p => p.Autors)
                ...
                .HasConstraintName("FK__Autor__IIDPAIS__5441852A");

            entity.HasOne(d => d.IidsexoNavigation).WithMany(p => p.Autors)
                .HasForeignKey(d => d.Iidsexo)
                .HasConstraintName("FK__Autor__IIDSEXO__5535A963");
        });
        ...
        modelBuilder.Entity<DetalleReserva>(entity =>
        {
            ...
            entity.HasOne(d => d.IidlibroNavigation).WithMany(p => p.DetalleReservas)
                ...
                .HasConstraintName("FK__DetalleRe__IIDLI__5629CD9C");

            entity.HasOne(d => d.IidreservaNavigation).WithMany(p => p.DetalleReservas)
                .HasForeignKey(d => d.Iidreserva)
                .HasConstraintName("FK__DetalleRe__IIDRE__571DF1D5");
        });
        ...
        modelBuilder.Entity<Libro>(entity =>
        {
            ...
            entity.HasOne(d => d.IidautorNavigation).WithMany(p => p.Libros)
                ...
                .HasConstraintName("FK__Libro__IIDAUTOR__5812160E");

            entity.HasOne(d => d.IidtipolibroNavigation).WithMany(p => p.Libros)
                .HasForeignKey(d => d.Iidtipolibro)
                .HasConstraintName("FK__Libro__IIDTIPOLI__59063A47");
        });
        ...
        modelBuilder.Entity<Reserva>(entity =>
        {
            ...
            entity.HasOne(d => d.IidestadoreservaNavigation).WithMany(p => p.Reservas)
                ...
                .HasConstraintName("FK__Reserva__IIDESTA__5DCAEF64");
        });
        ...
        modelBuilder.Entity<Usuario>(entity =>
        {
            ...
            entity.HasOne(d => d.IidpersonaNavigation).WithMany(p => p.Usuarios)
                ...
                .HasConstraintName("FK__Usuario__IIDPERS__619B8048");

            entity.HasOne(d => d.IidtipousuarioNavigation).WithMany(p => p.Usuarios)
                .HasForeignKey(d => d.Iidtipousuario)
                .HasConstraintName("FK__Usuario__IIDTIPO__628FA481");
        });
